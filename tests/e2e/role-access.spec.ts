...
test("Owner can open user settings", async ({ page }) => { await page.goto("/auth/demo?role=owner"); await page.goto("/settings/users"); await expect(page.getByRole("heading", { name: "Users & access", exact: true })).toBeVisible(); });
